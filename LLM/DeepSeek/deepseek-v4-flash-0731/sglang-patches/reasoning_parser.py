...
class BaseReasoningFormatDetector:
    ...
    def _parse_streaming_increment_impl(self, new_text: str) -> StreamingParseResult:
        ...
        if self._in_reasoning and self.think_end_token in current_text:
            ...
            # Backport of https://github.com/sgl-project/sglang/pull/34600
...
class DeepSeekV4Detector(BaseReasoningFormatDetector):
    def __init__(
        ...
        super().__init__(
            ...
            # Narrow to tool_calls wrapper — bare "<｜DSML｜" matched any DSML
            # sub-tag in reasoning and ended thinking prematurely (PR #34600).
