...
class DeepSeekV32Detector(BaseFormatDetector):
    ...
    # Backport of https://github.com/sgl-project/sglang/pull/34600 onto v0.5.17
    _DSML_TOOL_TAGS = [
        "<｜DSML｜invoke",
        "<｜DSML｜tool_calls",
        "<｜DSML｜function_calls",
    ...
    def finish(self, tools: list[Tool]) -> StreamingParseResult:
        ...
        Note: v0.5.17 serving code does not call detector.finish(); this is
        kept for compatibility if/when the runtime is upgraded.
        """
        if not self._buffer:
